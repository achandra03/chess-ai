...
GAMES_DIRECTORY = 'pgns'	# Directory where the pgn games are saved
STORING_PATH = 'evaluated_games'		# Where to store the games evaluated by Stockfish

#engine = chess.uci.popen_engine('stockfish/stockfish-exe')	# Be sure to have Stockfish installed
#engine.uci()
...
def process_game(game):
	...
	node = game
	movetime = 50	#Milliseconds, the lower the more approximate Stockfish's evaluation is
...
if __name__ == '__main__':
	...
	df = pd.read_csv('/Users/arnavchandra/Desktop/chess/data/chessData.csv')
	fens = df['FEN']
	evals = df['Evaluation']
	max_positions = 1000
